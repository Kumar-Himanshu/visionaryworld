...
import com.visionaryworld.camera.GraphicOverlay.Graphic
import java.util.*
...
class FaceGraphicOverlay(
     ...
     */
    abstract class Graphic(overlay: FaceGraphicOverlay) {
        private val mOverlay: FaceGraphicOverlay
