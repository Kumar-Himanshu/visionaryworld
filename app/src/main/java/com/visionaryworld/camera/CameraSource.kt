 ...
 * Note: This requires Google Play Services 8.1 or higher, due to using indirect byte buffers for storing images.
...
private constructor() {
     ...
     */
    @SuppressLint("unused")
    @RequiresPermission(allOf = arrayOf(Manifest.permission.CAMERA))
...
//        }
     ...
     */
    inner class PictureStartCallback : Camera.ShutterCallback {
     ...
     */
    inner class CameraAutoFocusCallback : Camera.AutoFocusCallback {
     ...
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    inner class CameraAutoFocusMoveCallback : Camera.AutoFocusMoveCallback {
    ...
    companion object {
        ...
        private fun generateValidPreviewSizeList(camera: Camera): List<SizePair> {
            ...
            if (validPreviewSizes.size == 0) {
                ...
                supportedPreviewSizes.mapTo(// The null picture size will let us know that we shouldn't set a picture size.
