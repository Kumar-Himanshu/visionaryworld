...
import com.visionaryworld.camera.CameraSource
import com.visionaryworld.camera.CameraSourcePreview
...
class MainActivity : AppCompatActivity(), ITextObserver {
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        preview = findViewById<CameraSourcePreview>(R.id.preview)
        graphicOverlay = findViewById<GraphicOverlay<OcrGraphic>>(R.id.graphicOverlay)
        ...
        val listener = OnInitListener { status ->
            if (status == TextToSpeech.SUCCESS) {
                Log.d(
                    "OnInitListener",
                    "Text to speech engine started successfully."
                )
                tts!!.language = Locale.US
            } else {
                Log.d(
                    "OnInitListener",
                    "Error starting the text to speech engine."
                )
            }
        }
    ...
    private fun createCameraSource(
        ...
        textRecognizer.setProcessor(OcrDetectorProcessor(graphicOverlay!!,this))
    ...
    override fun onTextRecieve(text: String) {
//        if (preview != null) {
//            preview!!.stop()
//        }
//        if(text.isValidAadharNumber()){
        var intent = Intent(this@MainActivity, TextActivity::class.java)
            intent.putExtra("Data",text)
            startActivity(intent)

//        }else{
//            Log.i("Received Text",text)
//        }
